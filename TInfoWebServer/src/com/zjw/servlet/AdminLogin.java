...
public class AdminLogin extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String re =loginDAO.checkAdminLogin(username, password);
		if(re.equals(Constant.RESPONSE_ERROR)){
			out.print(Constant.RESPONSE_ERROR);
		}else{
			out.print(new JSONObject().fromObject(UserInfoDAO.getAdminInfo(re)));
		}
		out.flush();
		out.close();
	}
