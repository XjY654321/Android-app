...
import com.zjw.dao.SrDAO;
import com.zjw.dao.UserInfoDAO;

import config.Constant;

public class AdminCK extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String id=new String(request.getParameter("kcid").getBytes("iso-8859-1"),"utf-8");
		String sr=new String(request.getParameter("sr").getBytes("iso-8859-1"),"utf-8");
		String name=new String(request.getParameter("name").getBytes("iso-8859-1"),"utf-8");
		String mobile=new String(request.getParameter("mobile").getBytes("iso-8859-1"),"utf-8");
		KCDAO.UpdateSL(id, sl);
		SrDAO.add(sr);
		LSDAO.add(id, sl, "出库",name,mobile);
