...
public class Pie1Activity extends BaseActivity {
    ...
    private String[] stateChar = {"新产品总价值", "旧产品总价值"};
...
//        initPieChart();
               ...
               int isNotNew = 0;
                ...
                for (int i = 0; i < b.size(); i++) {
                    if("是".equals(b.get(i).getNew_goods())){
                        isNew = isNew + (Integer.parseInt(b.get(i).getSl()) * Integer.parseInt(b.get(i).getJg()));
                    }else {
                        isNotNew = isNotNew + (Integer.parseInt(b.get(i).getSl()) * Integer.parseInt(b.get(i).getJg()));
                    }
                }
    ...
    private PieChartOnValueSelectListener selectListener = new PieChartOnValueSelectListener() {
        ...
        public void onValueSelected(int arg0, SliceValue value) {
            ...
            Toast.makeText(Pie1Activity.this, stateChar[arg0] + ":" + value.getValue(), Toast.LENGTH_SHORT).show();
        }
    };
